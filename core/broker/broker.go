...
import (
	...
	"github.com/ruixiaoedu/hiot/core/broker/lib/sessions"
	"github.com/ruixiaoedu/hiot/core/broker/lib/topics"
	...
	"github.com/ruixiaoedu/hiot/pool"
	"go.uber.org/zap"
...
func NewBroker(cfg *config.Config, things Things) (*Broker, error) {
	b := &Broker{
	...
	if cfg.TlsPort != "" {
		tlsConfig, err := config.NewTLSConfig(cfg.TlsInfo)
		if err != nil {
